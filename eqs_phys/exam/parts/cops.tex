% Для ортогональных полиномов бывает удобно использовать представление через формулу Родрига
% \begin{equation*}
%     f_n(x) = \frac{\alpha}{}
% \end{equation*}
...
\textbf{Полиномы Эрмита}. Живут на $(-\infty, +\infty)$, дифференциральное уравнение
\begin{equation*}
    \sigma = 1, \hspace{5 mm} 
    \tau = - 2 x,
