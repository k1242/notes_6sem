...
\newcommand{\Dq}{\mathcal{D}q\,}
\newcommand{\n}{\mathcal{N}}
\newcommand{\G}{\mathcal{G}^{(1)}}

\newcommand{\chain}[3]{#1\textnormal{#2}^{#3}\,}
\newcommand{\term}[3]{{}^{#1}\textnormal{#2}_{#3}}
\newcommand{\spin}[1]{\raisebox{-2.5pt}{\begin{modiagram}\atom{left}{#1}\end{modiagram}}\ }
...
\newcommand{\sbin}{_{\text{in}}}
\newcommand{\Ry}{\mathop{\mathrm{Ry}}\nolimits}
...
\newcommand{\Tsec}[1]{\subsection*{#1} \addcontentsline{toc}{subsection}{#1}}